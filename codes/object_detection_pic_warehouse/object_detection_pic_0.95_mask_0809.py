...
PATH_TO_CKPT = '/data/contest/models/mask_rcnn_inception_resnetv2/mask_rcnn_inception_resnet_v2_atrous_coco_2018_01_28/frozen_inference_graph.pb'
...
if __name__ == '__main__':
  ...
  PATH_TO_WRITE='/data/contest/data/test_results0.95_mask_0809/'
  imagelist = os.listdir(PATH_TO_TEST_IMAGES_DIR)
  if os.path.exists(PATH_TO_WRITE):
    shutil.rmtree(PATH_TO_WRITE)
    os.makedirs(PATH_TO_WRITE)
  ...
  bndbox_dic_all = {}
  # save to csv
  csvFile = open('/data/contest/data/bndbox_0.95_mask_0809.csv','w')
  ...
  np.save('/data/contest/data/bndbox_0.95_mask_0809.npy',bndbox_dic_all)
  print('saved!')
