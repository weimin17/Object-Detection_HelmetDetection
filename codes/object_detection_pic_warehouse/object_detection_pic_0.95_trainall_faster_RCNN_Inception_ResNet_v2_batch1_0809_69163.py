...
PATH_TO_CKPT = '/data/contest/savedModels/savedModel_69163_trainall_faster_RCNN_Inception_ResNet_v2_batch1_0809/frozen_inference_graph.pb'
...
if __name__ == '__main__':
  ...
  PATH_TO_WRITE='/data/contest/data/test_results0.95_trainall_faster_RCNN_Inception_ResNet_v2_batch1_0809_69163/'
  imagelist = os.listdir(PATH_TO_TEST_IMAGES_DIR)
  if os.path.exists(PATH_TO_WRITE):
    shutil.rmtree(PATH_TO_WRITE)
    os.makedirs(PATH_TO_WRITE)
  ...
  bndbox_dic_all = {}
  # save to csv
  csvFile = open('/data/contest/data/bndbox_0.95_trainall_faster_RCNN_Inception_ResNet_v2_batch1_0809_69163.csv','w')
  ...
  np.save('/data/contest/data/bndbox_0.95_trainall_faster_RCNN_Inception_ResNet_v2_batch1_0809_69163.npy',bndbox_dic_all)
  print('saved!')
