...
PATH_TO_WRITE='/data/contest/data/test_results_0.8_fasterrcnnv2_0802/'
...
np.save('/data/contest/data/bndbox_0.8_fasterrcnnv2_0802.npy',bndbox_dic_all)
print('saved!')

import csv

# save to csv
csvFile = open('/data/contest/data/bndbox_0.8_fasterrcnnv2_0802.csv','w')
