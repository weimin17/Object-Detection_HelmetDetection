...
if __name__ == '__main__':
    ...
    PATH_TO_WRITE = '/data/contest/data/test_results0.9faster_RCNN_Inception_ResNet_v2_0802/'
    ...
    for filename in imagelist:
        ...
        p.apply_async(detect_singe_img, args=(image_path, PATH_TO_WRITE, filename,), callback=mycallback)
