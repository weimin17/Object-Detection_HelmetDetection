...
if __name__ == '__main__':
  ...
  PATH_TO_WRITE='/data/contest/data/test_results0.9_faster_RCNN_Inception_ResNet_v2_alldata_batch1_55280_0807/'
  imagelist = os.listdir(PATH_TO_TEST_IMAGES_DIR)
  if os.path.exists(PATH_TO_WRITE):
    shutil.rmtree(PATH_TO_WRITE)
    os.makedirs(PATH_TO_WRITE)
  ...
  bndbox_dic_all = {}
  # save to csv
  csvFile = open('/data/contest/data/bndbox_0.9_faster_RCNN_Inception_ResNet_v2_alldata_batch1_55280_0807.csv','w')
  ...
  np.save('/data/contest/data/bndbox_0.9_faster_RCNN_Inception_ResNet_v2_alldata_batch1_55280_0807.npy',bndbox_dic_all)
  print('saved!')
