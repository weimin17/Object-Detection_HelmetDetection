...
PATH_TO_CKPT = '../savedModels/savedModel_50000_trainall_faster_RCNN_Inception_ResNet_v2_train-test_0814/frozen_inference_graph.pb'
...
if __name__ == '__main__':
  PATH_TO_TEST_IMAGES_DIR='../data/test/JPEGImages/'
  PATH_TO_WRITE='../data/test_results0.75_train-test_faster_RCNN_Inception_ResNet_v2_0814/'
  imagelist = os.listdir(PATH_TO_TEST_IMAGES_DIR)
  if os.path.exists(PATH_TO_WRITE):
    shutil.rmtree(PATH_TO_WRITE)
    os.makedirs(PATH_TO_WRITE)
  ...
  bndbox_dic_all = {}
  # save to csv
  csvFile = open('../data/bndbox_0.75_train-test_faster_RCNN_Inception_ResNet_v2_0814.csv','w')
  ...
  np.save('../data/bndbox_0.75_train-test_faster_RCNN_Inception_ResNet_v2_0814.npy',bndbox_dic_all)
  print('saved!')
